...
const shippingsList: Shipping[] = [
  new Shipping({id: 1, neighborhood: 'Novo Horizonte', value: 10, createdAt: new Date(), updatedAt: new Date()}),
  new Shipping({id: 2, neighborhood: 'Nossa Senhora de Fátima', value: 30, createdAt: new Date(), updatedAt: new Date()}),
  new Shipping({id: 3, neighborhood: 'Centro', value: 5, createdAt: new Date(), updatedAt: new Date()}),
];
